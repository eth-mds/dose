...
data-driven organ severity evaluation (DOSE) score (Poster P381 at
ISICEM 2020, also soon to be available online). The entirety of the code
will be uploaded in the coming weeks.
...
The DOSE score, trained on 75% of MIMIC data, 8 hours into ICU stay, is
now evaluated on the remaining 25% of data for hours 8, 16, 24 and
compared to SOFA at hour 24.
...
And finally, we evaluate DOSE trained on MIMIC, using data from HiRID
and we visualize how this behaves over time.
